  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <section id="top" className="relative z-10 flex min-h-[100svh] flex-col justify-between overflow-hidden bg-background px-6 pt-16 pb-10 text-center md:pt-20 md:pb-14">
        <div className="absolute inset-0 bg-[url('/hero-mobile.jpg')] md:bg-[url('/hero.jpg')] bg-cover bg-[position:60%_center] md:bg-[position:65%_center] opacity-90" aria-hidden="true" />
