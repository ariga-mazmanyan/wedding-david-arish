...
export default function Page() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <footer className="relative z-10 flex flex-col items-center gap-3 border-t border-primary/15 bg-white/80 px-6 pt-10 pb-24 text-center backdrop-blur-md sm:pb-16">
        <p className="font-dzeragir text-4xl text-primary sm:text-5xl">Դավիթ և Արիշ</p>
        <p className="font-mono text-[11px] uppercase tracking-[0.25em] text-muted-foreground">07 · 11 · 2026</p>
        <p className="mt-2 max-w-sm font-serif italic text-sm tracking-wider text-primary/80 sm:text-base sm:max-w-md leading-relaxed text-center px-2">
